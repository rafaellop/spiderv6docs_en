...
<h1>Tools - Table row</h1>

<p>This tool is used to create and edit the table row tag <tt>TR</tt>.</p><p>You launch the Table Row window from the <a href="main_menu_main.php">Main Menu</a> / <a href="main_menu_tools.php">Tools</a> / <a href="main_menu_tools_tables.php">Tables</a> / Table Row, as well as from the <a href="toolbars_tables.php">Tables and Forms</a> toolbar.</p><h2>TR tag settings</h2>

<p><b>Horizontal alignment</b><br>
...
Here you provide a unique identifier for this element in the document. These identifiers can be used, for example, when making jumps to specific parts of the page or in scripts.</p></td>
</tr>
</table>
