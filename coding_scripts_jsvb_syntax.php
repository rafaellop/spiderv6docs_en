...
<!-- nazwa strony pomocy -->
<title>Support for JavaScript and VBScript - Syntax highlighting</title>
...
<h1>Support for JavaScript and VBScript - Syntax highlighting</h1>


<!-- tre&#347;&#263; pomocy -->


<p>The primary help for writing JavaScript and VBScript scripts is <a href="syntax.php"> syntax highlighting </a> . In order to facilitate the work, JS and VBS coloring are combined with other languages. Thanks to this, it is possible, for example, to simultaneously create an HTML document with nested scripts. There are of course also JS and VBS only coloring schemes.</p><ul>
	<li><b>Dynamic HTML</b> - Coloring JavaScript and VBScript, as well as HTML and CSS (style sheets)</li>
	<li><b>Dynamic XHTML</b> - Coloring JavaScript and VBScript, as well as XHTML (the successor to HTML) and CSS (style sheets)</li>
	<li><b> HTML + JavaScript </b> - HTML and JavaScript coloring</li>
	<li><b>HTML + VBScript</b> - Coloring HTML and VBScript</li>
	<li><b>JavaScript</b> - Coloring only JavaScript</li>
	<li><b>VBScript</b> - Coloring for VBScript only</li>
</ul>You can also customize syntax highlighting. Use these tools for that:<ul>
